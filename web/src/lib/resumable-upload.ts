...
function errorMessageFromBody(body: string) {
  if (!body) return "";
  try {
...
export async function uploadHttpError(response: Response, fallback: string) {
...
function validOffset(value: string | null, totalBytes: number) {
